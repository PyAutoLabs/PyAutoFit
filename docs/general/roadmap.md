...
If you would like to see a non-linear search implemented in **PyAutoFit**, propose it in the
[Ideas & Proposals category of PyAutoLabs Discussions](https://github.com/orgs/PyAutoLabs/discussions/categories/ideas-proposals).
